...
setup(
    ...
    url='http://rshk.github.io/jhp',
    license='Apache License 2.0',
    author='Samuele Santi',
    author_email='samuele@samuelesanti.com',
    description='Jinja Hypertext Preprocessor',
    long_description='Jinja Hypertext Preprocessor',
    install_requires=install_requires,
    test_suite='jhp.tests',
